...
export class BackendService {
  ...
  getUserStudentDoc() {
    // return this.getDoc('USERS', this.afAuth.auth.currentUser.uid)
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
  ));
  }
  getUserStudentMSGDoc() {
    ...
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT')+'/'+res[0]['_id']+'/notifications').valueChanges()))));
  ...
  getUserStudentMSGCounts() {
    ...
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT')+'/'+res[0]['_id']+'/notifications', ref => ref.where('readReceipt', '==', true)).valueChanges()))));
   //.pipe(switchMap(res => this._afs.collection(this.getCollUrls('STUDENT')/res[0]['_id']/notifications, ref => ref.where('studentdocid', '==', res[0]['_id'])).valueChanges()))));
    } else return null;
  }
  getUserStudentFeeDoc() {
    ...
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('FEE'), ref => ref.where('studentdocid', '==', res[0]['_id'])).valueChanges()))));
  }
  getUserStudentMarksDoc() {
    // return this.getDoc('USERS', this.afAuth.auth.currentUser.uid)
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('MARKS'), ref => ref.where('studentdocid', '==', res[0]['_id'])).valueChanges()))));
  }
  getUserStudentTutsDoc(_url: any) {
    // return this.getDoc('USERS', this.afAuth.auth.currentUser.uid)
    return this.getDoc('USERS', this.authState.uid)
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls('STUDENT'), ref => ref.where('SKEY', '==', res['phone'])).valueChanges()
   .pipe(switchMap((res: any) => this._afs.collection(this.getCollUrls(_url), ref => ref.where('ENROLLMENT_CODE', '==', res[0]['ENROLLMENT_CODE'])).valueChanges()))));
  }
